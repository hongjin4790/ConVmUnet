...
class ConvNeXt(nn.Module):
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        # feature2 = self.features[2:4](feature1)
        # feature3 = self.features[4:](feature2)
        
        feature1 = self.features[:1](x)
        feature2 = self.features[1:3](feature1)
        feature3 = self.features[3:5](feature2)
        feature4 = self.features[5:](feature3)

       

        return feature4,[feature1, feature2, feature3]
...
def convnext_tiny(*, weights: Optional[ConvNeXt_Tiny_Weights] = None, progress: bool = True, **kwargs: Any) -> ConvNeXt:
    ...
    block_setting = [
        ...
        # CNBlockConfig(768, None, 3), # Cvmunet에서는 블록 3개만사용
    ]
